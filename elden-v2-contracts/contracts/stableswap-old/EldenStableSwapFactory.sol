...
contract EldenStableSwapFactory is Ownable {
    ...
    function createSwapPair(
        ...
        bytes memory bytecode = type(EldenStableSwap).creationCode;
        ...
        EldenStableSwap(swapContract).initialize(coins, _A, _fee, _admin_fee, msg.sender);
        ...
        info.token0 = t0;
        info.token1 = t1;
        info.LPContract = address(EldenStableSwap(swapContract).token());
        pairLength += 1;
